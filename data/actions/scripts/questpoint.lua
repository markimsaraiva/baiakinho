...
doPlayerSendTextMessage(cid,25,"Você recebeu seu item, clique nele e receba seus pontos!") -- Mensagem que aparecera quando ganhar o item.
...
doPlayerSendTextMessage(cid,25,"Você precisa ser level 400 ou mais.") -- Mensagem que ira aparecer se o player tiver menos level que o necessario.
