...
RewardPrimeiro = {6527,150}, -- RECOMPENSA/QUANTIDADE 1 COLOCADO
RewardSegundo = {6527,100}, -- RECOMPENSA/QUANTIDADE 2 COLOCADO
RewardTerceiro = {6527,50}, -- RECOMPENSA/QUANTIDADE 3 COLOCADO
tpPos = {x=159, y=51, z=7}, -- POSICAO QUE ABRE O TP
...
function StartCampoMinado()
	...
	reloadCampoMinado()
	doBroadcastMessage("{CampoMinado} Teleport fechado, evento ira iniciar em um minuto, crie sua estrat?ia!")
