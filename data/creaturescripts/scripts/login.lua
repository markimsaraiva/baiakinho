...
function onLogin(cid)
	...
	doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_RED, "[Promoção]: Double Points para todas as doações acima de R$20,00!")
...
registerCreatureEvent(cid, "AdvanceTeleport")
	...
	registerCreatureEvent(cid, "lootboss")
